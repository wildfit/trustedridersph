...
import { LogOut, Bike, Sun, Moon, Monitor } from "lucide-react";
          ...
          <div className="grid grid-cols-3 gap-2">
            {THEME_OPTIONS.map(({ value, label, Icon }) => (
              <button
                ...
                className={`tile flex flex-col items-center justify-center gap-2 p-3 text-sm ${
                  theme === value ? "tile-selected" : ""
                }`}
